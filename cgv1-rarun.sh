...
[ "x${CGV1_RARUN_BASE_DIR}" = 'x' ] && CGV1_RARUN_BASE_DIR='/dev'
[ "x${CGV1_RARUN_NAME}" = 'x' ] && CGV1_RARUN_NAME='nosubsys-cgv1'
[ "x${CGV1_RARUN_MOUNT_PATH}" = 'x' ] && CGV1_RARUN_MOUNT_PATH="${CGV1_RARUN_BASE_DIR}/${CGV1_RARUN_NAME}"
[ "x${CGV1_RARUN_MOUNT_OPTIONS}" = 'x' ] && CGV1_RARUN_MOUNT_OPTIONS="${CGV1_RARUN_NAME},none,nodev,noexec,nosuid,relatime"
[ "x${CGV1_RARUN_TRIGGER_NODE_PATH_NAME}" = 'x' ] && CGV1_RARUN_TRIGGER_NODE_PATH_NAME="${CGV1_RARUN_NAME}-run"
[ "x${CGV1_RARUN_TRIGGER_VERIFY_FILE}" = 'x' ] && CGV1_RARUN_TRIGGER_VERIFY_FILE="${CGV1_RARUN_BASE_DIR}/cgv1-rarun.ok"

[ "x${ALWAYS_CLEAN}" = 'x' ] && ALWAYS_CLEAN="false"
[ "x${BUT_I_USING_OLD_ANDROID}" = 'x' ] && BUT_I_USING_OLD_ANDROID="false"
[ "x${MAKE_RUN_PROG_PATH}" = 'x' ] && MAKE_RUN_PROG_PATH="true"
[ "x${PS}" = 'x' ] && PS="ps -wwef"
[ "x${SHEBANG}" = 'x' ] && SHEBANG="#!/bin/sh"
[ "x${RUN_PROG_PATH}" = 'x' ] && RUN_PROG_PATH="${CGV1_RARUN_BASE_DIR}/${CGV1_RARUN_TRIGGER_NODE_PATH_NAME}.sh"
